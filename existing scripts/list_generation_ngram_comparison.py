'''This implementation differs from list_generation_ngram_subset_selection.py in a way
...
'''The follwoing code block gives an API call on every query in the list newset
 ...
 and the received related queries are added as candidates to the list newset.
